...
public class PackedByteArrayNode extends DefaultNode implements MapNode
{
     ...
     */
    public PackedByteArrayNode(byte values[])
    {
        this.values = values;
    }
        ...
        throws AspException
    {
        ...
        return new Byte(values[value.intValue()]);
    }
    ...
    /**
     * Internal function to obtain the actual byte array.
     * @return byte array containing values in this array
     */
    public byte[] internGetValues()
    {
        return values;
    }
}
